...
const CreatePost = ({ isEdit }) => {
    ...
    const resetFieldsRef = useRef(null); // Sử dụng useRef để lưu callback
            ...
            <div className='flex gap-4'>
                <div className='py-4 flex flex-col gap-8 flex-auto'>
                    <Address
                        ...
                        resetFieldsCallback={(callback) => { resetFieldsRef.current = callback; }} // Lưu callback vào ref
                    />
