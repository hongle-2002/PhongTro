    ...
    return (
        <div className='flex flex-col gap-6'>
            ...
            <div className='py-4 border-b border-gray-200 flex items-center justify-between'>
                ...
                <div className='text-sm p-4 rounded-md text-blue-800 bg-blue-200 italic'>Sau khi xác nhận gia hạn, vui lòng chủ trọ hãy bank tiền gia hạn theo <a target='_blank' className='text-blue-500 hover:underline' href='http://zalo.me/0964533462'>tài khoản này</a> để admin duyệt nhé ~</div>
                        ...
                        : posts?.map(item => {
                            return (
                                <tr className='text-center' key={item.id}>
                                    <td className='text-center py-4 border-b'>{item?.id?.match(/\d/g).join('')?.slice(0, 6)}</td>
