        ...
        <div className='bg-white rounded-md p-4 flex flex-col items-center w-full gap-3'>
            ...
            <div className='flex flex-wrap gap-4 justify-between'>
                ...
                <span className='flex gap-2 w-[47%] flex-auto py-2 px-4 border items-center'>
                    ...
                    <a className='text-blue-500 hover:underline' href='tel:phone'>0964533462</a>
                </span>
                <span className='flex gap-2 w-[47%] flex-auto py-2 px-4 border items-center'>
                    <span className='font-medium'>Email:</span>
                    <a className='text-blue-500 hover:underline' href='mailto:mymail'>hongle936238@gmail.com</a>
                </span>
                <span className='flex gap-2 w-[47%] flex-auto py-2 px-4 border items-center'>
                    <span className='font-medium'>Zalo:</span>
                    <a className='text-blue-500 hover:underline' target='_blank' href='https://zalo.me/SĐT'>0964533462</a>
                </span>
            </div>
        </div>
    )
